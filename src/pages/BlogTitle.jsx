...
const BlogTitle = () => {
  const blogCategories = [
     'General','Business','Technology','Health','Lifestyle','Travel','Education','Finance','Entertainment','Food'
    ]
    ...
    const onSubmitHandler = async (e) => {
      ...
      try {
        setLoading(true)
        const prompt = `Generate a catchy blog title for the topic: "${input}" in the category "${selectedCategory}"`
  ...
  return (
     <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
        <div className='flex items-center gap-3'>
          <Hash className='w-6 h-8 text-[#8E37EB]' />
